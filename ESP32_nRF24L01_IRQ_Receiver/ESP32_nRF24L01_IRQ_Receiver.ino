//  ESP32_nRF24L01_IRQ_Receiver.ino  William Lucid 02/19/2024 @ 21:34 EST
...
//  Path:  "M:\■■■ Latest nRF24L01 Project\ESP32_nRF24L01_IRQ_Receiver\ESP32_nRF24L01_IRQ_Receiver.ino"
...
void setup() {
  ...
  rtc_gpio_init(IRQ_PIN);
  rtc_gpio_pullup_en(IRQ_PIN);
  rtc_gpio_set_direction(IRQ_PIN, RTC_GPIO_MODE_INPUT_ONLY);
  rtc_gpio_hold_dis(IRQ_PIN); //disable hold before setting the level
  rtc_gpio_set_level(IRQ_PIN, HIGH);  // Set output high
...
void loop() 
{
  ...
  { 
    ...
    Serial.println("Gets here... interrupt");
